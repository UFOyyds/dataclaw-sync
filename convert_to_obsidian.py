...
INPUT_FILE = Path(os.environ.get("DATACLAW_EXPORT", Path.home() / "dataclaw/exports/dataclaw_export.jsonl"))
OUTPUT_DIR = Path(os.environ.get("DATACLAW_OBSIDIAN_DIR", Path.home() / "ObsidianVault/AI对话记录"))
